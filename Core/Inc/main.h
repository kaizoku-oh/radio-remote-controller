...
#define STLINK_USART_TX_Pin GPIO_PIN_8
#define STLINK_USART_TX_GPIO_Port GPIOD
#define STLINK_USART_RX_Pin GPIO_PIN_9
#define STLINK_USART_RX_GPIO_Port GPIOD
